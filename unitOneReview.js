...
//CODE HERE
let favTreat = "skittles"
const powerLevel = 9001
let loveBlueLock = true 
...
//CODE HERE
const codingLanguage2 = codingLanguage.slice(1,2)
...
if(score <= 10){
    ...
    console.log('the score will be a c')
} else if (score > 40 && score < 71){
    console.log('the score will be a b')
} else if (score <70 ){
console.log ('the score will be an a')
}
...
*/
for(let i = 0; 1 < arrayName.legnth; i+++)
// !!! Don't edit the code below !!! //
let price = [10, 5, 6];
// !!! Don't edit the code above !!! //
